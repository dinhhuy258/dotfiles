...
utils.set_keymap('n', '<Leader>0', '<CMD>lua go_to_last_buffer()<CR>', { noremap = false })
...
utils.set_keymap('i', '<Leader>0', '<CMD>lua go_to_last_buffer()<CR>', { noremap = false })
